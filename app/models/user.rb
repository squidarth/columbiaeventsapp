class User < ActiveRecord::Base
   ...
   has_attached_file :avatar, :styles => { :thumb => "75x75>", :small => "150x150>", :normal => "300x300>" }, :storage => :s3, :s3_credentials => "#{RAILS_ROOT}/config/s3.yml", :path => ":attachment/:id/:style.:extension", :bucket => "ColumbiaEventsApp"
